    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.hasRatioIncreased) {
                ...
                sectionCurrentCount.innerHTML = '<i class="bi bi-arrow-up-right-circle me-1"></1> <span>' + data.countInCurrentMonth + '</span';
            }
            else {
                sectionCurrentCount.className = "text-danger me-1";
                sectionCurrentCount.innerHTML = '<i class="bi bi-arrow-down-right-circle me-1"></1> <span>' + data.countInCurrentMonth + '</span';
            }
